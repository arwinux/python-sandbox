...
class UiIptx(QMainWindow):
    ...
    def helpa(self):
        ...
        message_box.setText(self.setMessageBoxStyle(
            "Developer : Arvin Jafary <br><br> GitHub : <a href='https://github.com/arwinux'>arwinux</a> <br><br> Gmail : <a href='mailto:arwinux@gmail.com?subject=%3F&body=%3F'>arwinux@gmail.com</a>"))
        message_box.exec_()
